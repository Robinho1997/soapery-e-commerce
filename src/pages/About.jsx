  ...
  return (
    <div className="about-page">
      ...
      <div className="img-text-presentation-div">
        ...
        <p className="text">
          Für unsere Produkte verwenden wir keine Nanopartikel, kein
          Mikroplastik, kein Octocrylen, oder andere Inhaltsstoffe, die das
          Wachstum von Korallen beeinträchtigen.
        </p>
      </div>
      <p className="about-header">KORALLENSCHUTZ</p>
      <p className="about-text">
        SOAPERY pflegt Deine Haut vor der Sonne, ohne dabei Korallenriffe zu
        belasten.
      </p>
      <p className="about-text">
        Für unsere Produkte verwenden wir keine Nanopartikel, Mikroplastik,
        Octocrylen oder andere Inhaltsstoffe, die das Wachstum von Korallen
        beeinträchtigen. Zusätzlich unterstützen wir gemeinnützige
        Organisationen bei ihrer Arbeit für unsere Ozeane, wie z.B. die
        Initiative coralive.org, die sich mit Herzblut unter anderem der
        Wiederherstellung von Korallenriff- und Küstenökosystemen in betroffenen
        Gebieten widmen.
      </p>
      <p className="about-header">MADE IN GERMANY</p>
      <p className="about-text">
        SOAPERY wird zu 100% in Deutschland hergestellt (auch unsere
        Produktverpackungen). Wir achten auf möglichst kurze Transportwege, um
        unsere Umwelt nicht unnötig zu belasten.
      </p>
      <p className="about-header">DESIGN</p>
      <p className="about-text">
        Wir sind uns nicht nur unserer Verantwortung gegenüber unserer Haut und
        Umwelt bewusst, sondern möchten auch, dass du Spaß an unseren Produkten
        hast. So haben wir V.SUN mit viel Liebe zum Detail und unserer femininen
        Ästhetik entsprechend designed.
      </p>
      <p className="about-text">
