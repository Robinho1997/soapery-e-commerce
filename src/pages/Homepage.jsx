    ...
    <div className="home-page">
      ...
      <div className="img-text-presentation-div">
        ...
        {germanLanguage ? (
          ...
          <p className="text">
            SOAPERY offers perfectly coordinated care combined with delightful
            scents and responsible ingredients. Our soaps are carefully made
            with natural ingredients that are gentle on the skin and
            environmentally friendly. We are proud to offer a wide range of
            soaps.
          </p>
        )}
      </div>
